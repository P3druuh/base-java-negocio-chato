public class UsuarioComum extends Pessoa {
    ...
    private double valorViagemMetro = 5.40;
    private double valorViagemOnibus = 5.30;

    public UsuarioComum(String nomeCompleto, String email, String telefone, String CPF, String CEP, String dataNascimento,
    ...
    public void descontoOnibusComum25(){
        if (carteira.getPontos() >= 25){
            carteira.setPontos(carteira.getPontos()-25);
            this.valorViagemOnibus = 3.98;
            System.out.println("Usando 25 pontos, seu desconto de 25% foi aplicado!");
        } else {
            System.out.println("Pontos insuficientes!");
        }
    ...
    public void descontoOnibusComum50(){
        if (carteira.getPontos() >= 50){
            carteira.setPontos(carteira.getPontos()-50);
            this.valorViagemOnibus = 2.65;
            System.out.println("Usando 50 pontos, seu desconto de 50% foi aplicado!");
        } else {
            System.out.println("Pontos insuficientes!");
        }
    ...
    public void missao1Comum(){
        carteira.verificarMissao1();
    }

    public void missao2Comum(){
        carteira.verificarMissao2();
    }

    public void missao3Comum(){
