public class UsuarioVT extends Pessoa {
    ...
    public UsuarioVT(String nomeCompleto, String email, String telefone, String CPF, String CEP, String dataNascimento, String idUsuario, String nomeUsuario, String idBilheteUnico, String senha, int pontos, int viagemGraca) {
    ...
    public void converterPontosViagemVT(){
